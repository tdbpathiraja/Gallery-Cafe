    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li>
            <a class="nav-link active" href="promotions.php">Promotions</a>
          </li>
          <li>
      ...
      <div class="row">
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
            ...
            echo '<img src="assets/img/promotions/' . $row['image_url'] . '" width="410px" alt="Promotion Image" />';
            echo '<div class="promotion-content">';
            echo '<h3 class="promotion-title" style="text-align: center">' . $row['title'] . '</h3>';
            echo '<p class="promotion-text">' . $row['description'] . '</p>';
            echo '<p class="promotion-terms">' . $row['terms'] . '</p>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
          }
