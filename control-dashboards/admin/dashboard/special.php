...
// Fetch special meals
$query = "SELECT * FROM specialmeals";
    ...
    <header id="header" class="fixed-top d-flex align-items-cente">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li><a class="nav-link" href="beverages.php">Add Beverages</a></li>
                    ...
                    <li><a class="nav-link active" href="special.php">Add Specials</a></li>
                </ul>
        ...
        <div class="container">
            ...
            <div class="container-addmenu" data-aos="fade-up">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <form class="add-menu-form" action="../../../assets/database/dashboards/admin/menu_features/specials/add_menu_item.php" method="POST" enctype="multipart/form-data">
...
unset($_SESSION['error']); ?>
                        ...
                        <form class="delete-menu-form" action="../../../assets/database/dashboards/admin/menu_features/specials/delete_menu_item.php" method="POST">
                            <div class="form-group">
...
unset($_SESSION['error']); ?>
                        ...
                        <form class="edit-menu-form" action="../../../assets/database/dashboards/admin/menu_features/specials/edit_menu_item.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
