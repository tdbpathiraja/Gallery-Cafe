        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link active" href="desserts.php">Add Deserts</a></li>
        ...
        <div class="container">
            ...
            <div class="container-addmenu" data-aos="fade-up">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <form class="add-menu-form" action="../../../assets/database/dashboards/admin/menu_features/desserts/add_menu_item.php" method="POST" enctype="multipart/form-data">
...
unset($_SESSION['error']); ?>
                        ...
                        <form class="delete-menu-form" action="../../../assets/database/dashboards/admin/menu_features/desserts/delete_menu_item.php" method="POST">
                            <div class="form-group">
...
unset($_SESSION['error']); ?>
                        ...
                        <form class="edit-menu-form" action="../../../assets/database/dashboards/admin/menu_features/desserts/edit_menu_item.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
