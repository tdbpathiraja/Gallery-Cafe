...
<body>
    ...
    <section class="login-section">
        <div class="login-container">
            <h2>Admin Login</h2>
            <div id="message"></div>
            <form id="AdminTeamloginForm" method="POST" action="#">
        ...
        <br>
        <p>Please Don't share your login credential with any one this is the <b style="color: red;">Main System Login</b> Dashboard.</p>
        </div>
    </section>
