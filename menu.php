...
<body>
  ...
  <section class="inner-page">
    <div class="menucard-container">
      <div class="menu-card">
        <div class="menucard-img">
          <img src="assets/img/menu/Breakfast-Banner.png" />
        </div>
        <div class="menu-header">
          <div class="menu-title">Breakfast Menu</div>
          <p>8.00 am to 11.00 am</p>
        </div>
        <div class="menu-details">
          <div class="menu-description">
            Start your day with a delicious breakfast featuring a variety of
            fresh, healthy, and hearty options to suit all tastes.
          </div>
          <div class="menu-btn">
            <a href="pages/menu/breakfast.php">View Menu</a>
          </div>
        </div>
      </div>
      ...
      <div class="menu-card">
        <div class="menucard-img">
          <img src="assets/img/menu/Lunch-Banner.png" />
        </div>
        <div class="menu-header">
        ...
        <div class="menu-details">
          <div class="menu-description">
            Enjoy a variety of delectable lunch options, from light salads to
            hearty mains, all crafted with the finest ingredients.
          </div>
          <div class="menu-btn">
            <a href="pages/menu/lunch.php">View Menu</a>
          </div>
        </div>
      </div>
      ...
      <div class="menu-card">
        <div class="menucard-img">
          <img src="assets/img/menu/TeaTime-Banner.png" />
        </div>
        <div class="menu-header">
          <div class="menu-title">Tea Time</div>
          <p>3.30 pm to 5.30 pm</p>
        </div>
        <div class="menu-details">
          <div class="menu-description">
            Indulge in our delightful tea time offerings, including freshly
            baked pastries and a selection of fine teas.
          </div>
          <div class="menu-btn">
            <a href="pages/menu/tea-time.php">View Menu</a>
          </div>
        </div>
      </div>
      ...
      <div class="menu-card">
        <div class="menucard-img">
          <img src="assets/img/menu/Dinner-Banner.png" />
        </div>
        <div class="menu-header">
        ...
        <div class="menu-details">
          <div class="menu-description">
            Savor our exquisite dinner menu, featuring a range of gourmet
            dishes that promise to satisfy your evening cravings.
          </div>
          <div class="menu-btn">
            <a href="pages/menu/dinner.php">View Menu</a>
          </div>
        </div>
      </div>
    </div>
